...
OTHER_LANGS = ["eng", "deu_Latn", "arb_Arab", "cmn_Hani", "fra_Latn"]
...
# TOTAL_TOKENS = 250_000_000
# OTHER_LANGS = ["deu_Latn", "eng", "arb_Arab", "cmn_Hani", "fra_Latn"]
...
#         val_path = os.path.join(output_dir, f"{lang}_fine_val.bin")
#         print(f"Creating memory-mapped array at {val_path}...")
#         val_arr = np.memmap(val_path, dtype=np.uint32, mode="w+", shape=(target_tokens,))
